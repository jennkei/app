...
$messages['en'] = array(
	...
	'communitypage-help-edit-page' => 'How to edit a page',
	'communitypage-help-add-link' => 'How to add a link',
	'communitypage-help-add-new-page' => 'How to add a new page',
...
$messages['qqq'] = array(
	...
	'communitypage-help-module-edit-page-name' => 'Name of article from help namespace with help related to editing a page (without Help namespace prefix)',
...
$messages['de'] = array(
	...
	'communitypage-popularpages-title' => 'Beliebte Seiten',
	'communitypage-popularpages-edittext' => 'Lesen und verbessern',
...
$messages['es'] = array(
	...
	'communitypage-entry-tasks' => 'Ayúdanos a editar esta wiki',
	...
	'communitypage-wantedpages-description' => '¡Hay enlaces en rojo que apuntan a estas páginas, pero las páginas no existen! Crea el artículo o redirígelo al artículo correcto para ayudar a que los lectores naveguen tu wiki.',
...
$messages['it'] = array(
	...
	'communitypage-popularpages-title' => 'Pagine in tendenza',
	...
	'communitypage-todo-module-description' => "Questa è un'area per gli amministratori per suggerire ai nuovi collaboratori delle pagine che necessitano un intervento in modo da aiutarli ad iniziare. (Amministratori: ricordatevi di fornire dettagli su ciò che occorre fare.)",
...
$messages['ja'] = array(
	...
	'communitypage-help-add-new-page' => 'ページを追加するには',
...
$messages['pl'] = array(
	...
	'communitypage-other-admins' => 'Pozostali administratorzy',
	...
	'communitypage-todo-module-description' => 'Jest to obszar dla administratorów, w którym mogą sugerować strony, które wymagają pracy, aby pomóc nowym użytkownikom zacząć pracę. (Administratorze: pamiętaj, aby podać szczegóły tego, co powinno być zrobione.)',
...
$messages['ru'] = array(
	...
	'communitypage-todo-module-description' => 'Здесь администраторы размещают информацию о страницах, нуждающихся в доработке, чтобы новые участники могли сразу же приступить к редактированию. (Администраторы, не забудьте подробно объяснить, что необходимо сделать.)',
	'communitypage-todo-module-zero-state' => 'Хотите узнать, как вы можете помочь этому сообществу? Свяжитесь с администратором и попросите сообщить о нуждающихся в доработке страницах здесь.',
	...
	'communitypage-help-add-new-page' => 'Добавление новой страницы',
...
$messages['zh-hans'] = array(
	...
	'communitypage-todo-module-zero-state' => '想要知道如何对这个社区进行贡献吗？联系管理员并且告诉他们在这里提供建议。',
...
$messages['zh-hant'] = array(
	...
	'communitypage-popularpages-title' => '請校對這些頁面',
	'communitypage-popularpages-edittext' => '閱讀和修正',
	...
	'communitypage-todo-module-zero-state' => '想要知道你可以如何對這個社區進行貢獻嗎？聯繫管理員並且告訴他們在這裡提供建議。',
